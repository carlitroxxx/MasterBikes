...
const ArriendoForm = () => {
    ...
    useEffect(() => {
        const fetchBicicletas = async () => {
            try {
                const response = await axios.get('https://mb-inventario.onrender.com/api/inventario/arriendo');
    ...
    const buscarUsuarioPorRut = async (rut) => {
        ...
        try {
            const response = await axios.get(`https://mb-usuario.onrender.com/api/auth/buscar-por-rut?rut=${rut}`);
            if (response.data) {
                setForm({
                    ...form,
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            await axios.post('https://mb-arriendo.onrender.com/api/arriendos', dataToSend);

            // Luego actualizar el estado de la bicicleta a no disponible
            await axios.put(`https://mb-inventario.onrender.com/api/inventario/arriendo/${form.bicicleta.id}`, {
                ...form.bicicleta,
                disponible: false
            });
